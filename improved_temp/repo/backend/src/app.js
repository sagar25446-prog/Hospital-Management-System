...
// Stricter limiter for the public symptom checker: it's unauthenticated and,
// when ANTHROPIC_API_KEY is set, each call costs real money — 20/15min/IP
// is enough for genuine use without being an easy abuse vector.
