...
function parseDate(str) {
  ...
  // JS silently rolls over impossible calendar dates (e.g. 2026-02-30
  // becomes 2026-03-02) instead of producing an invalid Date, so
  // isNaN(getTime()) alone doesn't catch it — verify the round trip.
  const [, y, m, day] = match;
  if (
