...
function fuzzyMatch(inputText, keyword) {
  ...
  // Reverse check – handles partial typing of a *single* term (e.g.
  // "arthrit" matches "arthritis"). Deliberately NOT applied to
  // multi-word keywords: doing so let one generic shared word (e.g.
  // "pain") false-match against every unrelated "X pain" phrase across
  // specialties, which could outscore a real exact match like "chest
  // pain" and misroute something as serious as chest pain to Orthopedic.
